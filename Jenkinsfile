pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/alexanmf'                                                                    //<------your MiamiID
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/alexanmf/225-lab3-7.git'                                    //<------your MiamiID
        KUBECONFIG = credentials('alexanmf-225')                                                         //<------your MiamiID
    }
        ...
        stage ("Run Security Checks") {
            steps {
                ...
                sh '''
                    ...
                    -e BURP_START_URL=http://10.48.10.148 \
